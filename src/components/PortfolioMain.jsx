  ...
  return (
    <div name="portfolio" className='bg-gradient-to-b from-gray-900 to-gray-800 w-full text-white md:h-screen'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full '>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 border-fuchsia-600 '>Portfolio</p>
          <p className='py-6 '>Check out some of my work right here</p>
        </div>

        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src, hrefDemo, hrefCode }) => (
            <div key={id} className="shadow-md shadow-fuchsia-800/50 rounded-lg hover:shadow-fuchsia-800/80 duration-300 transform transition-transform hover:scale-105">
              <img
                src={src}
                alt=""
              ...
              <div className="flex items-center justify-center">
                <button className="w-1/2 px-6 py-3 m-4 duration-300 hover:scale-105 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-md">
